...
export const seasonalEvents = [
  ...
  },
  {
    ...
    date: '2026-05-27',
    range: '5 月 26 日（傍晚） - 5 月 27 日',
    markets: ['中东', '东南亚'],
    categories: ['家居小家电', '快时尚女装', '美妆个护'],
    status: 'upcoming',
    suggestion:
      '聚焦家庭聚会与互赠场景：烤肉 / 慢炖锅等器具备货 +40%；阿语本地化新衣 SKU 提前 14 天上架；礼盒装香水 / 个护组合优先曝光；客服值班覆盖中东 + 印尼 / 马来时区',
  },
  {
    name: '美国父亲节',
    date: '2026-06-21',
  ...
  {
    name: 'Amazon Prime Day 2026（防御战）',
    date: '2026-06-01',
    range: '6 月（具体日期 Amazon 待官宣，比往年提前 1 个月，覆盖美 / 英 / 德 / 法 / 意 / 西 / 加 / 墨 / 沙特 / 阿联酋等 26 国）',
    markets: ['北美', '欧洲', '中东', '东南亚', '拉美'],
    categories: ['3C 配件', '家居小家电', '美妆个护', '户外运动'],
    status: 'upcoming',
    suggestion:
      '比往年提前 1 个月：备货节奏整体前置 30 天，5 月中旬必须完成头程入仓；提前 14 天囤备爆款；站外联盟同步预算；价格守恒承诺锁住老客；详情页加价格对比锚点',
  },
  {
    name: '返校季预热',
    date: '2026-07-25',
